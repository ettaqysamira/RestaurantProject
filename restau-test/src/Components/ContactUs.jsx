...
<div className="flex justify-center p-28 gap-4">
    ...
    <div className="flex justify-center gap-6 m-8 z-10 sticky">
...
<div className="flex justify-center items-center m-8 gap-16 ">
...
<p className="text-[27px] font-libre-caslon">A modern restaurant with a menu that will make your mouth water.</p>

<div className="flex items-center w-[60%] gap-6 mt-10">
<div><FaBellConcierge  size={50}/></div>
<div>
  <h4 className="text-xs font-noah ml-4 uppercase tracking-[0.5em] font-semibold text-customColor">Reservation</h4>
  <h2 className="font-libre-caslon text-[24px]">+2125 28 54 62 48</h2>
</div>
